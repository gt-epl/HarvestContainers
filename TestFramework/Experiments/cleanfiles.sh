...
rm -rf /mnt/extra/results/multi-primary/*

rm -rf /mnt/extra/results/memcached-irq/*
rm -rf /mnt/extra/results/mysql-irq/*
rm -rf /mnt/extra/results/xapian-irq/*


rm -rf /mnt/extra/logs/memcached/*
rm -rf /mnt/extra/logs/mysql/*
rm -rf /mnt/extra/logs/xapian/*
rm -rf /mnt/extra/logs/multi-primary/*

rm -rf /mnt/extra/logs/memcached-irq/*
rm -rf /mnt/extra/logs/mysql-irq/*
rm -rf /mnt/extra/logs/xapian-irq/*
